...
// configuration step. It creates a namespace called `marcel`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", marcel::cmake::project_name, marcel::cmake::project_version) };
